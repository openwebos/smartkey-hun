...
numWords = 0
numWordsWithGuesses = 0
numCorrect = 0
numAutoAccept = 0
numWordsSpelledCorrectly = 0
...
if not writeRawWord then
	...
	puts "Num words with guesses|#{numWordsWithGuesses}"
	puts "Num words spelled correctly|#{numWordsSpelledCorrectly}"
	puts "Num words with auto-accept|#{numAutoAccept}"
	puts "Num words with correct guesses|#{numCorrect}"
end
